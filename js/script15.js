...
function updateUILanguage() {
    ...
    if (h1) h1.textContent = isEnglish ? 'Mouths, Disgust' : 'Bouches, Dégout';
    ...
    if (instructionText) {
        instructionText.textContent = isEnglish 
            ...
            : 'Ces dessins, ces neuf points et ces chiffres sont là. à dessein ! Il faut que je comprenne la logique, pour que nous utilisions du premier coup la bouche d\'aération dont la grille n\'est pas coulée dans le béton, sinon notre évasion échouera..';
    }
    ...
    if (objectiveText) {
        objectiveText.textContent = isEnglish 
            ...
            : 'choisir la bonne bouche d\'aeration par laquelle s\'échaper.';
    }
    ...
    if (hintText) {
        hintText.textContent = isEnglish 
            ...
            : 'les chiffres sur les carrrés representtant les bouche d\'aération.';
    }
            ...
            item.addEventListener('click', function() {
                ...
                if (hintText) {
                    hintText.textContent = isEnglish
                        ...
                        : "Indice trouvé! Regardez attentivement le motif dans les chiffres.";
                }
